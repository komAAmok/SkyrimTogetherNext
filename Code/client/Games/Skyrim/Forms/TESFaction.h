...
// Every member modelled above lives in the form record itself, not behind an
// ExtraDataList, so the 1.5.x/1.6.x difference in that embedded list does not
// reach here: one set of offsets holds for both builds.
