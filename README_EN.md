...
- **Guided graphical installer**: The mod package embeds a FOMOD installer (natively supported by MO2); multiplayer files install automatically, leaving only the two genuinely optional choices (1.6.x launch validation script, standalone launcher) to you;
