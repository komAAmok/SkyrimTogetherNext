...
| --- | --- | --- |
| 1.1.5 | 2026-09-27 | Fixed a malformed fmt placeholder in the plugin patch (a CI `error C7595`) and stopped the overlay helper from loading ENB's proxy DLLs, which surfaced as a KiLoader initialization failure; the recommended build is now 1.1.1, marked as the stable row |
