...
This repository is a **playable distribution**, not just framework source. Everything multiplayer needs ships in one installer: no manual configuration of the game, install it in MO2 and connect. Scene synchronisation, body and appearance, equipment display and item trading between players come from **six optional companion plugins** you pick in the wizard - installing none of them still leaves multiplayer fully working.
